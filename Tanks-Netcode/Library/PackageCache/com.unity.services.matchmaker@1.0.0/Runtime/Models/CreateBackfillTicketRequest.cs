...
namespace Unity.Services.Matchmaker.Models
{
    ...
    internal class CreateBackfillTicketRequest
    {
        ...
        /// <param name="properties">An object that will contain the data representing a Backfill Ticket. The information about the backfill ticket properties are stored in the Data property of that object. The Backfill Ticket Properties have to be serialized in base64</param>
        ...
        /// <summary>
        /// An object that will contain the data representing a Backfill Ticket. The information about the backfill ticket properties are stored in the Data property of that object. The Backfill Ticket Properties have to be serialized in base64
        /// </summary>
        [Preserve]
