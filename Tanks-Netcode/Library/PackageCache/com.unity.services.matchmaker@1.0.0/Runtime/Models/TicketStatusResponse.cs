...
namespace Unity.Services.Matchmaker.Models
{
    ...
    public class TicketStatusResponse : IOneOf
    {
        ...
        /// <summary>TicketStatusResponse Constructor</summary>
        /// <param name="value">The value as an object for TicketStatusResponse</param>
        /// <param name="type">The type for TicketStatusResponse</param>
        ...
        private static List<Type> PossibleTypes = new List<Type>(){ typeof(MultiplayAssignment)  };
        ...
        public static TicketStatusResponse FromJson(string jsonString)
        {
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("TicketStatusResponse", DiscriminatorKey);
                }
        ...
        private static TicketStatusResponse DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new TicketStatusResponse(actualObject, concreteType);
        }

        private static TicketStatusResponse DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new TicketStatusResponse(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for TicketStatusResponse to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class TicketStatusResponseJsonConverter : JsonConverter
    {
