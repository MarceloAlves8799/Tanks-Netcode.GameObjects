...
namespace Unity.Services.Matchmaker.Backfill
{
    ...
    /// <summary>
    /// BackfillApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class BackfillApiBaseRequest
    {
        /// <summary>
    ...
    /// <summary>
    /// ApproveBackfillTicketRequest
    /// Approve a backfill ticket
    /// </summary>
    [Preserve]
    internal class ApproveBackfillTicketRequest : BackfillApiBaseRequest
    {
        ...
        /// <summary>
        /// ApproveBackfillTicket Request Object.
        /// Approve a backfill ticket
        /// </summary>
        ...
        public Dictionary<string, string> ConstructHeaders(string accessToken,
    ...
    /// </summary>
    [Preserve]
    internal class CreateBackfillTicketRequest : BackfillApiBaseRequest
    {
        /// <summary>Accessor for createBackfillTicketRequestParameter </summary>
        [Preserve]
        public Unity.Services.Matchmaker.Models.CreateBackfillTicketRequest CreateBackfillTicketRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// CreateBackfillTicket Request Object.
        /// Create a backfill ticket
        /// </summary>
        /// <param name="createBackfillTicketRequestParameter">CreateBackfillTicketRequest param</param>
        [Preserve]
        public CreateBackfillTicketRequest(Unity.Services.Matchmaker.Models.CreateBackfillTicketRequest createBackfillTicketRequestParameter = default(Unity.Services.Matchmaker.Models.CreateBackfillTicketRequest))
        {
            CreateBackfillTicketRequestParameter = createBackfillTicketRequestParameter;
            PathAndQueryParams = $"/v2/backfill";
        ...
        public byte[] ConstructBody()
        {
            if(CreateBackfillTicketRequestParameter != null)
            {
                return ConstructBody(CreateBackfillTicketRequestParameter);
            }
            return null;
        }
    ...
    /// <summary>
    /// DeleteBackfillTicketRequest
    /// Delete a backfill ticket
    /// </summary>
    [Preserve]
    internal class DeleteBackfillTicketRequest : BackfillApiBaseRequest
    {
        /// <summary>Accessor for id </summary>
        [Preserve]
        public string Id { get; }
        ...
        /// <summary>
        /// DeleteBackfillTicket Request Object.
        /// Delete a backfill ticket
        /// </summary>
        /// <param name="id">Ticket ID or Backfill Ticket ID.</param>
        [Preserve]
        public DeleteBackfillTicketRequest(string id)
        {
            Id = id;
    ...
    /// <summary>
    /// UpdateBackfillTicketRequest
    /// Update a backfill ticket
    /// </summary>
    [Preserve]
    internal class UpdateBackfillTicketRequest : BackfillApiBaseRequest
    {
        /// <summary>Accessor for id </summary>
        [Preserve]
        public string Id { get; }
        /// <summary>Accessor for backfillTicket </summary>
        [Preserve]
        public Unity.Services.Matchmaker.Models.LegacyBackfillTicket BackfillTicket { get; }
        string PathAndQueryParams;

        /// <summary>
        /// UpdateBackfillTicket Request Object.
        /// Update a backfill ticket
        /// </summary>
        /// <param name="id">Ticket ID or Backfill Ticket ID.</param>
        /// <param name="backfillTicket">BackfillTicket param</param>
        [Preserve]
        public UpdateBackfillTicketRequest(string id, Unity.Services.Matchmaker.Models.LegacyBackfillTicket backfillTicket = default(Unity.Services.Matchmaker.Models.LegacyBackfillTicket))
        {
            Id = id;
