...
namespace Unity.Services.Matchmaker.Tickets
{
    ...
    internal class CreateTicketRequest : TicketsApiBaseRequest
    {
        ...
        [Preserve]
        public CreateTicketRequest(Unity.Services.Matchmaker.Models.CreateTicketRequest createTicketRequestParameter = default(Unity.Services.Matchmaker.Models.CreateTicketRequest))
        {
    ...
    internal class DeleteTicketRequest : TicketsApiBaseRequest
    {
        ...
        [Preserve]
        public DeleteTicketRequest(string id)
        {
            Id = id;
            PathAndQueryParams = $"/v2/tickets";
    ...
    internal class GetTicketStatusRequest : TicketsApiBaseRequest
    {
        ...
        /// <param name="id">Ticket ID or Backfill Ticket ID. The ID is obtained from the response of the Create operation.</param>
        [Preserve]
        public GetTicketStatusRequest(string id)
        {
            Id = id;
